...
#define CVAR_NONE 		QBIT(0) 	// No property (can be omitted)
#define CVAR_ARCHIVE 	QBIT(1)	// CVAR saved on the CFG.
#define CVAR_SERVERINFO QBIT(2)	// Informative CVAR from the server.
#define CVAR_ROM	 	QBIT(3) 	// Only set by the engine.
#define CVAR_DEBUG		QBIT(4)	// CVARs only enabled if the DEBUG flag is set.

// Specific platform CVARs. (ToDo)
#define CVAR_PSVITA		QBIT(5)
#define CVAR_PSTV		QBIT(6)
