...
#define	U_MOREBITS	QBIT(0)
#define	U_ORIGIN1	QBIT(1)
#define	U_ORIGIN2	QBIT(2)
#define	U_ORIGIN3	QBIT(3)
#define	U_ANGLE2	QBIT(4)
#define	U_NOLERP	QBIT(5)		// don't interpolate movement
#define	U_FRAME		QBIT(6)
#define U_SIGNAL	QBIT(7)		// just differentiates from other updates

// svc_update can pass all of the fast update bits, plus more
#define	U_ANGLE1	QBIT(8)
#define	U_ANGLE3	QBIT(9)
#define	U_MODEL		QBIT(10)
#define	U_COLORMAP	QBIT(11)
#define	U_SKIN		QBIT(12)
#define	U_EFFECTS	QBIT(13)
#define	U_LONGENTITY	QBIT(14)
